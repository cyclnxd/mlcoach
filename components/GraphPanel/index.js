...
let charts = ["ScatterChart", "AreaChart","BarChart","LineChart","PieChart","BubbleChart","ColumnChart","Histogram"]
...
function Graph({ onDelete, isDisplay, parentDimensions }) {
  ...
  return (
    <Stack sx={{ color: "primary.dark" }} spacing={0} direction="column">
      ...
      {openDialog ? (
        <GraphEditor data={fileMap} onClose={dialogHandler} columns={prevCol.current} />
      ) : (
        <></>
      )}
      <Box
        sx={{
          ...
          height: `${parentDimensions.height * 2.89}vw`,
          width: `${parentDimensions.width * 8.34}vw`,
          backgroundColor: "primary.darkLight",
        }}
      >
          ...
          >
            ...
            >
              ...
              <Autocomplete
                ...
                onChange={(event, value) => {chartType = value
                axisChanged = !axisChanged}}
