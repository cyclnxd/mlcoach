    ...
    if (page === 1) {
      ...
      return (
        <>
          ...
          >
            <Typography>Mean {mean !== Infinity ? mean.toFixed(2) : 0} </Typography>
            <Typography>Median {median !== 1.7976931348623157e308 ? median : 0}</Typography>
            <Typography>
              Maximum {maximum !== 1.7976931348623157e308 ? maximum : 0}
            </Typography>
            <Typography>Minimum {minimum !== 1.7976931348623157e308 ? minimum : 0}</Typography>
          </Box>
          <Pagination
            page={page}
            onChange={handlePagination}
